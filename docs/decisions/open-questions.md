...
| Q26 | Quem abre conversas de atendimento e quem atende? | Qualquer usuário com `support.use` (todos os perfis) abre conversas. Atendem usuários da Matriz com `support.manage` (Operador, Gestor, Administrador). A Matriz vê todas as conversas do tenant; os demais, só as que abriram. |
