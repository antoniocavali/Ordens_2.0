...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'auth.passkey.added': 'Passkey cadastrada',
  'auth.passkey.renamed': 'Passkey renomeada',
  'auth.passkey.removed': 'Passkey removida',
  'auth.passkey.failed': 'Login com passkey recusado',
