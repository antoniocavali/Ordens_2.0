...
export const NAVIGATION: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Commodities', href: '/commodities', icon: Wheat, permission: 'commodity.manage', soon: true },
    ],
  },
  {
    label: 'Cadastros',
    items: [
      { label: 'Compradores', href: '/cadastros/compradores', icon: Building2, permission: 'partner.manage', soon: true },
      { label: 'Vendedores', href: '/cadastros/vendedores', icon: UserRound, permission: 'partner.manage', soon: true },
      { label: 'Fazendas', href: '/cadastros/fazendas', icon: Sprout, permission: 'farm.read', soon: true },
      { label: 'Transportadoras', href: '/cadastros/transportadoras', icon: Boxes, permission: 'carrier.manage', soon: true },
      { label: 'Motoristas', href: '/cadastros/motoristas', icon: Users, permission: 'carrier.manage', soon: true },
      { label: 'Veículos', href: '/cadastros/veiculos', icon: Package, permission: 'carrier.manage', soon: true },
